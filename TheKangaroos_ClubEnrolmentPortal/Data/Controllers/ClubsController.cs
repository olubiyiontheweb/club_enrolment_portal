...
namespace TheKangaroos_ClubEnrolmentPortal.Data.Controllers
{
    public class ClubsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,Image")] Club club)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Id,Name,Description,Image")] Club club)
        {
            if (id != club.Id)
            {
                return NotFound();
